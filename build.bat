...
echo   [*] dist\GiftVoucherCategorizer\GiftVoucherCategorizer.exe
echo.
echo To run:
echo   1. Run: dist\GiftVoucherCategorizer\GiftVoucherCategorizer.exe
echo   2. Keep _internal\ next to the exe (required at runtime)
echo   3. Enter your OpenAI API key when prompted
echo   4. Select a CSV file to categorize
echo.
